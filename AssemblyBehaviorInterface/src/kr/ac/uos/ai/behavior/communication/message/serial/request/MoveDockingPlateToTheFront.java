...
public class MoveDockingPlateToTheFront extends SerialMessage {

	public MoveDockingPlateToTheFront(String sender, String actionID) {
		super(sender, ActionType.MoveDockingPlateToTheFront, actionID);
	}
