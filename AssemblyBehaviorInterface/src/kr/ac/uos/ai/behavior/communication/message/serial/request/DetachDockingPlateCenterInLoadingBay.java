...
public class DetachDockingPlateCenterInLoadingBay extends SerialMessage {

	public DetachDockingPlateCenterInLoadingBay(String sender, String actionID) {
		super(sender, ActionType.DetachDockingPlateCenterInLoadingBay, actionID);
	}
