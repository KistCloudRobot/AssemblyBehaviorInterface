...
public class RotateToLabelPosition extends SerialMessage {

	public RotateToLabelPosition(String sender, String actionID) {
		super(sender, ActionType.RotateToLabelPosition, actionID);
	}
	...
	public String makeResponse() {
		...
		if(responseMessage instanceof TrayResponseMessage) {
			...
			if(((TrayResponseMessage) responseMessage).getResponse().equals("<OUT07=0_ACK>")) {
