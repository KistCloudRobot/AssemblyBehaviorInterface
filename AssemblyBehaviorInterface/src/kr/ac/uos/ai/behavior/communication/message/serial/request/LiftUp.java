...
public class LiftUp extends SerialMessage {

	public LiftUp(String sender, String actionID) {
		super(sender, ActionType.LiftUp, actionID);
	}
	...
	public String makeResponse() {
		...
		if(responseMessage instanceof TrayResponseMessage) {
			...
			if(((TrayResponseMessage) responseMessage).getResponse().equals("<OUT06=0_ACK>")) {
