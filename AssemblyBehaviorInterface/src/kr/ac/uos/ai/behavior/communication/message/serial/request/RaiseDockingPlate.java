...
public class RaiseDockingPlate extends SerialMessage {

	public RaiseDockingPlate(String sender, String actionID) {
		super(sender, ActionType.RaiseDockingPlate, actionID);
	}
