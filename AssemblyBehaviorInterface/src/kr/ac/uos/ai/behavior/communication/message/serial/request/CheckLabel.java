...
public class CheckLabel extends SerialMessage {

	public CheckLabel(String sender, String actionID) {
		super(sender, ActionType.CheckLabel, actionID);
	}
