...
public class LiftDown extends SerialMessage {

	public LiftDown(String sender, String actionID) {
		super(sender, ActionType.LiftDown, actionID);
	}
	...
	public String makeResponse() {
		...
		if(responseMessage instanceof TrayResponseMessage) {
			...
			if(((TrayResponseMessage) responseMessage).getResponse().equals("<OUT06=1_ACK/>")) {
