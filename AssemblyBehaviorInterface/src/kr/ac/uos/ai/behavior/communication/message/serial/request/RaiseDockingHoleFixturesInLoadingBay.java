...
public class RaiseDockingHoleFixturesInLoadingBay extends SerialMessage {

	public RaiseDockingHoleFixturesInLoadingBay(String sender, String actionID) {
		super(sender, ActionType.RaiseDockingHoleFixturesInLoadingBay, actionID);
	}
