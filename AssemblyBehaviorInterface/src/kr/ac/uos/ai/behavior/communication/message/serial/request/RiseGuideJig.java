...
public class RiseGuideJig extends SerialMessage {

	public RiseGuideJig(String sender, String actionID) {
	...
	public String makeResponse() {
		...
		if(responseMessage instanceof SubPCResponseMessage) {
			...
			if(((SubPCResponseMessage) responseMessage).getResponse().equals("<CHK>SOL=OK</CHK>")) {
