...
public class DetachDockingPlateSideFixturesInLoadingBay extends SerialMessage {

	public DetachDockingPlateSideFixturesInLoadingBay(String sender, String actionID) {
		super(sender, ActionType.DetachDockingPlateSideFixturesInLoadingBay, actionID);
	}
